...
Please report vulnerabilities privately so they can be assessed before public disclosure.
...
To report a security issue, please use the GitHub Security Advisories tab in this repository to open a draft security advisory. This is the preferred method as it provides a built-in private communication channel.
...
When deploying and using codego-api, we recommend following these security best practices:
...
Use the repository README and deployment files as the source of truth for configuration.
