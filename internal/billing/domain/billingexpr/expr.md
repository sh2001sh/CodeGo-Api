...
**File**: `internal/gateway/store/billing_setting.go`
...
**File**: `internal/gateway/runtime/pricing.go` → `modelPriceHelperTiered()`
...
**Files**: `internal/billing/app/tiered_settle.go`, `internal/billing/domain/billingexpr/settle.go`
...
| Layer | Files |
|-------|-------|
| Expression engine | `internal/billing/domain/billingexpr/compile.go`, `run.go`, `settle.go`, `round.go`, `types.go` |
| Storage | `internal/gateway/store/billing_setting.go` |
| Pre-consume | `internal/gateway/runtime/pricing.go`, `internal/gateway/runtime/billing_expr_request.go` |
| Settlement | `internal/billing/app/tiered_settle.go`, `internal/billing/app/text_quota.go` |
| Log injection | `internal/billing/app/log_info.go` |
