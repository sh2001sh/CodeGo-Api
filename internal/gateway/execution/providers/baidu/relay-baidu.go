...
func baiduStreamHandler(c *gin.Context, info *relaycommon.RelayInfo, resp *http.Response) (*types.APIError, *dto.Usage) {
	usage := &dto.Usage{}
...
func baiduHandler(c *gin.Context, _ *relaycommon.RelayInfo, resp *http.Response) (*types.APIError, *dto.Usage) {
...
func baiduEmbeddingHandler(c *gin.Context, _ *relaycommon.RelayInfo, resp *http.Response) (*types.APIError, *dto.Usage) {
