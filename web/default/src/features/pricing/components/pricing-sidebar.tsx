...
function FilterChip(props: {
  ...
  return (
    <button
      ...
      className={cn(
        'group inline-flex max-w-full min-w-0 items-center gap-2 rounded-lg px-2.5 py-1.5 text-xs font-medium transition-colors',
        props.active
      ...
      {(props.option.suffix || props.option.count != null) && (
        <span
          className={cn(
            ...
            props.active ? 'text-background/70' : 'text-muted-foreground/55'
          )}
        >
...
export function PricingSidebar(props: PricingSidebarProps) {
  ...
  return (
    <aside className={cn('bg-card rounded-2xl border p-3', props.className)}>
