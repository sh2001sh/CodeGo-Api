...
const CHANNEL_TYPE_DISPLAY_ORDER: number[] = [
  ...
  18, 45, 31, 35, 49, 19, 47, 37, 38, 39, 11, 8, 57, 22, 21, 44, 36, 50, 51, 52,
  53, 54, 56,
]
...
export const TYPE_TO_KEY_PROMPT: Record<number, string> = {
  ...
  50: 'Format: AccessKey|SecretKey (or just ApiKey if upstream is codego-api)',
...
export const CHANNEL_TYPE_WARNINGS: Record<number, string> = {
  ...
  8: 'If connecting to an upstream relay project, use OpenAI type unless you know what you are doing',
